...
import ai.eve.volley.Delivery;
import ai.eve.volley.HttpUtils;
...
import ai.eve.volley.RetryPolicy;
import ai.eve.volley.ServerError;
import ai.eve.volley.TimeoutError;
import ai.eve.volley.stack.HttpStack;
		...
		while (true) {
			...
			try {
				...
				if (responseContents != null) {
					...
					//TODO 修改BUG  throw new NetworkError(networkResponse);
