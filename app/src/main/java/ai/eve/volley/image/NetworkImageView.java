...
import ai.eve.volley.toolbox.ImageLoader.ImageContainer;
import ai.eve.volley.toolbox.ImageLoader.ImageListener;
...
public class NetworkImageView extends ImageView {
    ...
    public void setImageUrl(String url, ImageLoader imageLoader,int pixels) {
        mUrl = url;
        mImageLoader = imageLoader;
        // The URL has potentially changed. See if we need to load it.
        loadImageIfNecessary(false);
                ...
                new ImageListener() {
                    ...
                    public void onSuccess(final ImageContainer response, boolean isImmediate) {
						...
						if (response.getBitmap() != null) {
							if(pixels!=-1){
								setImageBitmap(toRoundCorner(response.getBitmap(),pixels));
							}else{
